...
The challenger role can contribute the vision scenarios taking the customer's wishes into consideration. The axes and dimensions for these can be seen in \Cref{fig:axis2}.
%\begin{itemize}
