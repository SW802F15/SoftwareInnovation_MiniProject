...
For our early configuration table \citep[ pp. 16-17 and 105-106]{essence} we have our second release. The first release was very small and produced a music player which now needs to be expanded to become a running pacer, takings steps per minute into account when selecting the next song from a queue.
